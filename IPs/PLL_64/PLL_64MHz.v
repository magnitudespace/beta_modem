...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n PLL_64MHz -lang verilog -synth lse -arch xo3c00a -type pll -fin 16 -fclkop 64 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -rst -fb_mode 1 -lock  */
/* Fri Dec 01 12:12:39 2017 */


`timescale 1 ns / 1 ps
module PLL_64MHz (CLKI, RST, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire LOCK;
