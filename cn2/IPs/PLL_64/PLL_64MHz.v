...
/* Module Version: 5.7 */
/* /usr/local/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n PLL_64MHz -lang verilog -synth lse -arch xo3c00a -type pll -fin 16 -fclkop 64 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Thu Jan 17 16:06:03 2019 */


`timescale 1 ns / 1 ps
module PLL_64MHz (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
